...
const SingleBlogRead = ({
  ...
  return (
    <div className={`font-pop ${className}`}>
      ...
      <Image src={blogImgPath} imgClass={"w-3/5 m-auto mt-9"} />
      ...
      <p className="text-justify mt-7 leading-7 text-primary/70 text-base">
        এই আয়োজনে অংশগ্রহণ করতে পারেন যেভাবেঃ <br /> ১. ভলান্টিয়ার হিসেবে
        (অনুষ্ঠানে সরাসরি অংশগ্রহণ করতে ভলান্টিয়ার হিসেবে রেজিস্ট্রেশন আবশ্যক।
        রেজিস্ট্রেশন চার্জ ৩০০/-। পাচ্ছেন টিশার্ট, আইডি কার্ড, সার্টিফিকেট ও
        লাঞ্চবক্স।)
      ...
      <p className="text-justify mt-3 leading-7 text-primary/70">
        ভলান্টিয়ার বা ডোনার হিসেবে যুক্ত হতে চাইলে রেজিস্ট্রেশন লিংক <br />{" "}
        কিভাবে রেজিস্ট্রেশন করবেনঃ <br /> ১) দাতা/ ভলান্টিয়ার হিসেবে এই উদ্যোগে
        যুক্ত হতে চাইলে প্রথমে রেজিস্ট্রেশন লিংকের ফর্মটি পূরণ করতে হবে। এরপর
        ফি/অনুদান পাঠিয়ে রেজিস্ট্রেশন সম্পন্ন করতে হবে। <br /> ২) ফি/অনুদান
        পাঠানোর পর DLSH স্পেস ফর্ম অনুযায়ী নাম স্পেস যে নাম্বার থেকে ফি/অনুদান
        পাঠাবেন উক্ত নাম্বার উল্লেখ করে মেসেজ করুন 01794013834 এই
        নাম্বারে।উদাহরণঃ DLSH Mesbah Munna 01816-656455 ফিরতি মেসেজে আপনাকে একটি
        কোড দেওয়া হবে। কোড পেয়ে গেলেই আপনার রেজিস্ট্রেশন সম্পন্ন হবে।কোভিড
        সংক্রমণের ফলে নিরাপত্তাজনিত কারণে ইভেন্টের দিন কোড নাম্বার ছাড়া কাউকে
