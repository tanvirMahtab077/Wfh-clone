...
const NotFound = () => {
  return (
    <div className="h-screen text-white relative">
        ...
        <img  className='absolute brightness-50 top-0 w-full h-full z-[-1]' src="https://images.unsplash.com/photo-1519681393784-d120267933ba?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=2070&q=80" alt="" />
    </div>
  )
}
