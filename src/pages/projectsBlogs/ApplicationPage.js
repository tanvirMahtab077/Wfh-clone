                    ...
                    <div className='lg:mr-10'>
                        ...
                        <div className='font-sans text-[#8c8c8c] w-full text-[15px]'>
                            ...
                            <div className='float-left'>
                                <PostsNavButton link={"/portfolio/business-card/"}><HiOutlineChevronLeft /> Previous Post</PostsNavButton>
                            </div>
                            <div className='float-right'>
                                <PostsNavButton link={"/portfolio/health-camp-medicine-educational-equipment-for-flood-victim-children/"}>Next Post <HiOutlineChevronRight /></PostsNavButton>
                            </div>
                        </div>
                    </div>
