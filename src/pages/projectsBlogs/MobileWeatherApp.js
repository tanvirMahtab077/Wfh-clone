...
import img from '../../Assests/Imgs/portfolio-7.jpg'
import PostsNavButton from '../../components/postsNavButton/PostsNavButton';
import { HiOutlineChevronLeft, HiOutlineChevronRight } from 'react-icons/hi';

const MobileWeatherApp = () => {
    const header = "Mobile Weather App"
    return (
        <div>
                    ...
                    <div className='lg:mr-10'>
                        ...
                        <div className='font-sans text-[#8c8c8c] w-full text-[15px]'>
                            ...
                            <div className='float-left'>
                                <PostsNavButton link={"/portfolio/lowpoly-social/"}><HiOutlineChevronLeft /> Previous Post</PostsNavButton>
                            </div>
                            <div className='float-right'>
                                <PostsNavButton link={"/portfolio/business-card/"}>Next Post <HiOutlineChevronRight /></PostsNavButton>
                            </div>
                        </div>
                    </div>
