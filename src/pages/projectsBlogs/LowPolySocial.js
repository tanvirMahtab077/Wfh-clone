                    ...
                    <div className='lg:mr-10'>
                        ...
                        <div className='font-sans text-[#8c8c8c] w-full text-[15px]'>
                            ...
                            <div className='float-left'>
                                <PostsNavButton link={"/portfolio/special-bikes/"}><HiOutlineChevronLeft /> Previous Post</PostsNavButton>
                            </div>
                            <div className='float-right'>
                                <PostsNavButton link={"/portfolio/mobile-weather-app/"}>Next Post <HiOutlineChevronRight /></PostsNavButton>
                            </div>
                        </div>
                    </div>
