...
import img from '../../Assests/Imgs/portfolio-10.jpg'
import PostsNavButton from '../../components/postsNavButton/PostsNavButton';
import { HiOutlineChevronRight } from 'react-icons/hi';

const ModeratsElo = () => {
    const header = "Moderats eloquenti"
    return (
        <div>
                    ...
                    <div className='lg:mr-10'>
                        ...
                        <div className='font-sans text-[#8c8c8c] w-full text-[15px]'>
                            ...
                            <div className='float-right'>
                                <PostsNavButton link={"/portfolio/special-bikes/"}>Next Post <HiOutlineChevronRight /></PostsNavButton>
                            </div>
                        </div>
                    </div>
