        ...
        <SingleBlogRead
          ...
          paraThree={
            <Fragment>
              ...
              <Link to={"/be-a-volunteer"}>রেজিস্ট্রেশন লিংক</Link> <br />{" "}
              কিভাবে রেজিস্ট্রেশন করবেনঃ <br />
              <br /> ১) দাতা/ ভলান্টিয়ার হিসেবে এই উদ্যোগে যুক্ত হতে চাইলে
              প্রথমে রেজিস্ট্রেশন লিংকের ফর্মটি পূরণ করতে হবে। এরপর ফি/অনুদান
              পাঠিয়ে রেজিস্ট্রেশন সম্পন্ন করতে হবে। <br /> ২) ফি/অনুদান পাঠানোর
              পর DLSH স্পেস ফর্ম অনুযায়ী নাম স্পেস যে নাম্বার থেকে ফি/অনুদান
              পাঠাবেন উক্ত নাম্বার উল্লেখ করে মেসেজ করুন 01794013834 এই
              নাম্বারে।উদাহরণঃ DLSH Mesbah Munna 01816-656455 ফিরতি মেসেজে
              আপনাকে একটি কোড দেওয়া হবে। কোড পেয়ে গেলেই আপনার রেজিস্ট্রেশন
              সম্পন্ন হবে।কোভিড সংক্রমণের ফলে নিরাপত্তাজনিত কারণে ইভেন্টের দিন
              কোড নাম্বার ছাড়া কাউকে প্রবেশ করতে দেওয়া হবেনা।
            </Fragment>
          }
        />
